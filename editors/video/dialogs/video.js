      ...
      contents: [{
        ...
        elements: [
          ...
          },
          {
            id: 'preview',
            type: 'html',
            html: '<label>' + editor.lang.video.preview + '</label><div class="cke_dialog_ui_labeled_content" style="position:relative;background-color:#f8f8f8;border:1px solid #d1d1d1;"><div style="height:0;padding-top:56.25%"><div style="position:absolute;bottom:0;left:0;right:0;top:0;"><video preload="metadata" style="width:100%;height:auto;display:none;"></video></div></div></div>'
          }
        ]
      }],
      onLoad: function() {
