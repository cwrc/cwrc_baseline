...
var inputMask = {
  ...
  handleCurrentValue : function (e) {
    var isCharsetPresent = e.target.getAttribute('data-charset'),
        ...
        value = e.target.value, l = placeholder.length, newValue = '', numValue,
        i, j, isInt, isLetter, strippedValue, matchesNumber, matchesLetter, charValue;
    ...
    for (i = 0, j = 0; i < l; i++) {
        ...
        numValue = this.opts.mNum.indexOf(placeholder[i]);
        charValue = this.opts.mChar.indexOf(placeholder[i]);
        matchesNumber = numValue >= 0;
        matchesLetter = charValue >= 0;
        if ((matchesNumber && isInt) || (isCharsetPresent && matchesLetter && isLetter[0] == 'X' && i == (l - 1))) {
  ...
  validateProgress : function (e, value) {
    ...
    // Test the value, removing the last character, until what you have is a
    // submatch.
    for (i = l; i >= 0; i--) {
